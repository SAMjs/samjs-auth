    ...
    return function(samjs) {
      ...
      return new (Auth = (function() {
        function Auth() {
          ...
          var callPermissionChecker, getAllowance, getIdentifier, isAllowed;
          ...
          this.permissionCheckers = {
            containsUser: function(permission, user, getIdentifier) {
              if (getIdentifier) {
                if (user != null) {
          ...
          getIdentifier = function(user, permissionChecker) {
            if (permissionChecker == null) {
              permissionChecker = samjs.options.permissionChecker;
            }
            if (samjs.util.isArray(permissionChecker)) {
              ...
              if (this.permissionCheckers[permissionChecker] == null) {
                throw new Error(permissionChecker + " not defined");
              }
              return this.permissionCheckers[permissionChecker](null, user, true);
            } else if (samjs.util.isFunction(permissionChecker)) {
              return permissionChecker(null, user, true);
            }
          };
          isAllowed = function(socket, permission, permissionChecker) {
            var ref, result;
          ...
          this.hooks = {
            configs: {
              beforeTest: function(obj) {
                isAllowed(obj.socket, this.access.write, this.permissionChecker);
                return obj;
              },
              beforeGet: function(obj) {
                isAllowed(obj.socket, this.access.read, this.permissionChecker);
                return obj;
              },
